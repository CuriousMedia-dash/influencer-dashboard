...
import { Sun, Moon, LogOut, UserPlus, Users } from "lucide-react";
import { useCreators } from "../../hooks/useCreators";
import { useTheme } from "../../hooks/useTheme";
import { useAuth } from "../../hooks/useAuth";
import { timeAgo } from "../../utils/format";
import InviteBrandModal from "../ui/InviteBrandModal";
import InviteTeamModal from "../ui/InviteTeamModal";
...
export default function Header({ onGearClick }) {
  ...
  return (
    ...
    >
      ...
      <InviteTeamModal open={inviteTeamOpen} onClose={() => setInviteTeamOpen(false)} />
    </header>
  );
}